...
public class WeaponShop : MonoBehaviour
{
    ...
    private void AutoAssignReferences()
    {
        ...
        if (gPrompt == null)
            gPrompt = FindChildUnderRootFuzzy("Player", "gpromptweapon");

        if (shopUI == null)
            shopUI = FindChildUnderRootFuzzy("PlayerUI", "weaponshoppanel");
    ...
    {
        Debug.Log("[WeaponShop] BuyItem ezen fut: " + gameObject.name, this);
